...
Je suis aujourd'hui CTO dans la startup [Diag n' Grow](https://www.diagngrow.com/). 

Ma stack technique est la suivante : 

- Backend : Django (Ninja, Celery)
- Frontend : VueJS (Pinia, Vite, Vuetify)
- IA : scikit-learn, tensorFlow, LangChain, LangGraph

## Intérêts et projets actuels:

- Agents IA / workflow agentique
...
- 01 Jan, 2024 : Je deviens CTO chez [Diag n' Grow](https://www.diagngrow.com/)
- 07 Aou, 2023 : Je rejoins l'équipe de [Diag n' Grow](https://www.diagngrow.com/) en tant que responsable R&D
